...
function App() {
  ...
  const handleRemovePlace = useCallback(function handleRemovePlace() {
    ...
    const filteredStoredIds = storedIds.filter((place) =>place !== selectedPlace.current);
    localStorage.setItem('pickedPlaces', JSON.stringify(filteredStoredIds));
    ...
    <>
      ...
      <main>
        ...
        <Places
          ...
          fallbackText={'No places found. Try to enable geolocation.'}
